...
test('applies core slices but skips the seed by default', async () => {
  ...
  assert.deepEqual(applied, ['001_authz', 'V1_baseline', '002_agent_runtime', '003_admin', '004_location_grants_admin', '005_invites', '006a_contractor_kind', '006_contracts', '007_location_geo']);
